...
![重新释放内核](/images/360-lite-browser-force-release-qwvkernel.png)
...
![常驻开发者设置](/images/360-lite-browser-developer-settings-in-settings-activity.png)

除了表面上的常驻，其实**开启后还会启用一些我们开发者调试所需要的一些功能**，比如WebView的调试（开启后可以通过电脑端的Chrome浏览器inspect调试网页）等等。

**还有一些功能可能也会通过这个模式开启哦，欢迎大家尝试！🌈🥚🌈🥚🌈🥚**

_P.S. 之前酷安上说过的功能哈，你们懂的！_

_突然在想，是不是可以把Chrome里的小恐龙跳跳跳游戏搞过来。_
